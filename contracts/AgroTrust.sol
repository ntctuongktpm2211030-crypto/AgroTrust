...
import "./modules/InspectionManager.sol";
 ...
 * từ (Storage -> Roles -> Farms -> Batches -> Logs -> Inspections). Khối mã được chia tách logic ra các 
 ...
 */
contract AgroTrust is InspectionManager {
